...
def detect_speech_duration(audio_path: str, sample_rate: int = 16000, 
    ...
    NOTE: This is a fallback method. STT word timestamps are more accurate.
    ...
    try:
        ...
        return max(0.1, speech_duration)
...
def detect_speech_segments(audio_data: np.ndarray, sample_rate: int = 16000,
    ...
    NOTE: This is rarely used now. Word count-based estimation is more accurate.
    ...
    try:
        ...
        for start_sample, end_sample in intervals:
            speech_intervals.append((start_sample / sample_rate, end_sample / sample_rate))
            total_speech_samples += (end_sample - start_sample)
        
        return max(0.1, total_speech_samples / sample_rate), speech_intervals
